                      ...
                      <div class="card">
                          <div class="card-image">
                              <figure class="image is-4by3">
                                  <img src="/uploads/property/{{ strtolower($gedung->property->type) }}/{{json_decode($gedung->property->images)[0]}}" alt="Placeholder image">
                              </figure>
                          </div>
                          <div class="card-content">
                              <div class="media">
                                  ...
                                  <div class="media-content">
                                      <p class="is-6">
                                          <span class="has-text-dark">Nama :</span> {{$gedung->property->name}} <br>
                                          <span class="has-text-dark">Jenis :</span> {{$gedung->property->type}} <br>
                                          <span class="has-text-dark">Lokasi :</span> {{$gedung->property->city}} <br>
                                          <span class="has-text-dark">Harga :</span> Rp. {{number_format($gedung->property->amount,2)}}</p>
                                  </div>
                              </div>
                              <div class="content">
                                  <small class media-left>{{$gedung->property->created_at->diffForHumans()}}</small>
                                  <div class="buttons is-pulled-right">
                                      <button class="button is-success is-pulled-right" onclick="window.open('/gedung/{{$gedung->id}}','_blank');">Detail</button>
                                  </div>
                              </div>
                          </div>
                      </div>
