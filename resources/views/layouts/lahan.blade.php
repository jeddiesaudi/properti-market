        ...
        <div class="container">
            <div class="columns is-mobile is-centered">
               <div class="column is-8 searchbox">
                  ...
                  {{-- Search Box --}}
                <form method="POST" action="/lahan/search">
                  @csrf
                        ...
                        <div class="card">
                            <div class="card-image">
                                <figure class="image is-4by3">
                                    <img src="/uploads/property/{{ strtolower($land->property->type) }}/{{json_decode($land->property->images)[0]}}" alt="Placeholder image">
                                </figure>
                            </div>
                            <div class="card-content">
                                <div class="media">
                                    ...
                                    <div class="media-content">
                                        <p class="is-6">
                                            ...
                                            <span class="has-text-dark">Jenis :</span> {{$land->property->type}} <br>
                                ...
                                <div class="content">
                                    <small class media-left>{{$land->property->created_at->diffForHumans()}}</small>
                                    <div class="buttons is-pulled-right">
                                        <button class="button is-success is-pulled-right" onclick="window.open('/lahan/{{$land->id}}','_blank');">Detail</button>
                                    </div>
                                </div>
                            </div>
                        </div>
