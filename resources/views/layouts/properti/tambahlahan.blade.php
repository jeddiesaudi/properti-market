...
<body>
    ...
    <br>
    <div class="title has-text-centered">Tambah Lahan</div>
    <br>
    <div class="container">
                ...
                <div class="column">
                    ...
                    <div class="field">
                        <div class="control">
                            ...
                            <input class="input is-primary {{ $errors->has('postalcode') ? ' is-danger' : '' }}"
                                type="text" name="postalcode" value="{{ old('postalcode') }}">
                    ...
                    <div class="field">
                        <div class="control">
                            ...
                            <input class="input is-primary {{ $errors->has('contactno') ? ' is-danger' : '' }}"
                                type="text" name="contactno" value="{{ old('contactno') }}">
                    ...
                    <div class="field">
                        <div class="control">
                            ...
                            <input class="input is-primary {{ $errors->has('contactemail') ? ' is-danger' : '' }}"
                                type="text" name="contactemail" value="{{Auth::user()->email}}">
                ...
                <div class="column">
                    ...
                    <div class="field">
                        <div class="control">
                            ...
                            <br>
                            <div class="select is-primary {{ $errors->has('tapwater') ? ' is-danger' : '' }}">
