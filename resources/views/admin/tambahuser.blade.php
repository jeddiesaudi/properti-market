            ...
            <form action="/admin/user/tambah" method="post" enctype="multipart/form-data">
              ...
              <div class="field">
                ...
                <p class="control has-icons-left">
                  <input class="input" type="text" placeholder="Masukkan Nama Akun" name="name">
              ...
              <div class="field">
                ...
                <p class="control has-icons-left">
                  <input class="input" type="email" placeholder="Masukkan Email Akun" name="email">
                  <span class="icon is-small is-left">
                    <i class="fas fa-at"></i>
                  </span>
                </p>
              ...
              <div class="field">
                ...
                <p class="control has-icons-left">
                  <input class="input" type="password" placeholder="Masukkan Password Akun" name="password">
                  <span class="icon is-small is-left">
