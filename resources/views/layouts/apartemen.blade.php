        ...
        <div class="container">
            <div class="columns is-mobile is-centered">
               <div class="column is-8 searchbox">
                  ...
                  {{-- Search Box --}}
                <form method="POST" action="/apartemen/cari">
                  @csrf
                        ...
                        <div class="card">
                            <div class="card-image">
                                <figure class="image is-4by3">
                                    <img src="/uploads/property/{{ strtolower($apartemen->property->type) }}/{{json_decode($apartemen->property->images)[0]}}" alt="Placeholder image">
                                </figure>
                            </div>
                            <div class="card-content">
                                <div class="media">
                                    ...
                                    <div class="media-content">
                                        <p class="is-6">
                                            <span class="has-text-dark">Nama :</span> {{$apartemen->property->name}} <br>
                                            <span class="has-text-dark">Jenis :</span> {{$apartemen->property->type}} <br>
                                            <span class="has-text-dark">Lokasi :</span> {{$apartemen->property->city}} <br>
                                            <span class="has-text-dark">Harga :</span> Rp. {{number_format($apartemen->property->amount,2)}}</p>
                                    </div>
                                </div>
                                <div class="content">
                                    <small class media-left>{{$apartemen->property->created_at->diffForHumans()}}</small>
                                    <div class="buttons is-pulled-right">
                                        <button class="button is-success is-pulled-right" onclick="window.open('/apartemen/{{$apartemen->id}}','_blank');">Detail</button>
                                    </div>
                                </div>
                            </div>
                        </div>
