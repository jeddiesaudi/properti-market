...
<head>
    ...
    <title>Ganti Password - Sabar Ganda Property</title>
    ...
    <div class="columns fulllogin is-centered">
        <div class="column is-two-thirds leftsideeffect">
            ...
            <div class="is-mobile textboxlogin">
                <p class="subtitle has-text-dark is-6 has-text-centered">{{ ('Hai! User') }}</p>
                <p class="title has-text-primary is-4 has-text-centered">{{ __('Ganti Password Anda') }}</p>
            </div>
            <div class="columns is-mobile is-centered">
                <div class="column is-half">
                    @if (session('resent'))
                    <div class="notification is-success is-size-7">
                        <button class="delete"></button> {{ __('Tautan pengaturan ulang kata sandi telah dikirim ke alamat email Anda.')
                        }} </div>
                    @endif
                </div>
            </div>
            <div class="column is-8 is-offset-2">
                    <form method="POST" action="{{ route('password.update') }}">
                            ...
                            <div class="field">
                                <label for="email" class="label">{{ __('Masukkan E-Mail') }}</label>
                            ...
                            <div class="field">
                                <label for="password-confirm" class="label">{{ __('Konfirmasi Password') }}</label>
