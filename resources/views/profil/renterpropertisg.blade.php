<div class="column displaybox">
    ...
    <nav class="breadcrumb has-arrow-separator profileback breadcrumbcss" aria-label="breadcrumbs">
        <ul>
            ...
            <li class="is-active"><a href="/profil">Daftar Penyewa Properti</a></li>
        </ul>
    </nav>
    ...
    <div class="card cardmargin">
        <div class="containerx">
            <h1 class="title has-text-centered">Daftar Penyewa Properti <br>{{ $house->property->name }}</h1>
            <div class="is-grouped">
                <span class="mr-3 text-danger">Stok Tersedia: {{ $house->stok }}</span>
                <button class="button is-success is-pulled-right" onclick="window.open('/profil/propertisg/{{$house->id}}/rent','_blank');">Tambah Penyewa</button>
            </div><br>
