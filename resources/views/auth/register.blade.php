...
<head>
    ...
    <title>Register - Sabar Ganda Property</title>
...
<body class="grayme">
    ...
    <div class="columns fulllogin">
        <div class="column is-offset-1 is-half leftsideeffect">
            ...
            <div class="is-mobile textboxlogin">
                <p class="title has-text-primary is-4 has-text-centered">Register Akun</p>
                <p class="subtitle  has-text-centered is-size-7 tinytextlogin">Masukkan email dan kata sandi Anda untuk masuk ke akun properti Anda.</p>
            </div>
            <div class="loginform">
                    ...
                    <div class="field">
                        <p class="control has-icons-left">
                            <input
                                ...
                                id="name" type="text" value="{{ old('name') }}" name="name" placeholder="Masukkan Nama"
                                autofocus>
    ...
    <div class="column is-one-third rightsideeffect has-background-primary">
        <div class="is-mobile textboxlogin textareabox">
            <p class="title has-text-white is-4 has-text-centered">Halo, Kawan</p>
            <p class="subtitle  has-text-white has-text-centered is-size-7 tinytextlogin">Masukkan biodata Anda dan mulailah berbisnis bersama kami.</p>
