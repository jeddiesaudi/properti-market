...
<head>
    ...
    <title>Admin - Sabar Ganda Property</title>
    ...
    <div class="columns fulllogin is-centered">
        <div class="column is-two-thirds leftsideeffect">
            ...
            <div class="is-mobile textboxlogin">
                <p class="title has-text-primary is-4 has-text-centered">Login Akun Super Admin</p>
                <p class="subtitle  has-text-centered is-size-7 tinytextlogin">Masukkan email dan password untuk login</p>
            </div>
            <div class="loginform">
